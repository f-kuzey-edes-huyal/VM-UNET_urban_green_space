...
def process_geotiff_folder(folder_path, target_size=(128, 128), channels_to_use=19):
...
def calculate_mean_std_of_channels(images_tensor, channels_to_use=19):
...
def process_multiple_folders(folders, target_size=(128, 128), channels_to_use=19):
...
processed_images = process_multiple_folders(folders, target_size=(128, 128), channels_to_use=19)

# Calculate mean and std for each channel and overall
mean_channels, std_channels, mean_all_channels, std_all_channels = calculate_mean_std_of_channels(processed_images, channels_to_use=19)
