...
import timm
from datasets.dataset_omdena import NPY_datasets
...
def main(config):
    ...
    train_loader = DataLoader(train_dataset, batch_size=8, shuffle=True, pin_memory=True, num_workers=config.num_workers)
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        val_loss = val_one_epoch(val_loader, model, criterion, epoch, logger, config)
